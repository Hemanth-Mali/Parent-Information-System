...
mydb = mysql.connector.connect(host="localhost", user="root", password="hemanth@777",database="hemanth")
smtp_server = "smtp.gmail.com"
port = 587
sender_email = "hemu@gmail.com"
email_password = '1234567890'
context = ssl.create_default_context()
botNumber ='+16316023183'
account_sid = 'XXX YOUR TWILIO ACC ID HERE XXX'
auth_token = 'XXX YOUR ACC TOKEN HERE XXX'
